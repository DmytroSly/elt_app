...
def load_select_tables_from_database() -> None:
    ...
    source_1 = sql_database().with_resources("customers", "employees")

    # Add incremental config to the resources. "updated" is a timestamp column in these tables that gets used as a cursor
    source_1.customers.apply_hints(incremental=dlt.sources.incremental("updated"))
    source_1.employees.apply_hints(incremental=dlt.sources.incremental("updated"))
    ...
    #source_2 = sql_database().with_resources("features", "author")
