...
import drafts.metadata_old as metadata_old
from drafts.metadata_old import get_pipeline_connections, get_connection_info, get_credentials, get_incremental_column
reload(metadata_old)
